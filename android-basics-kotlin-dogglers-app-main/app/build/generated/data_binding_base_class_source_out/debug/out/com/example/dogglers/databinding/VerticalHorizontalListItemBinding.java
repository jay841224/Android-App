...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView dogHabbies;
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView dogAge, @NonNull TextView dogHabbies, @NonNull ImageView dogImage,
      @NonNull TextView dogName) {
    this.rootView = rootView;
    this.dogAge = dogAge;
    this.dogHabbies = dogHabbies;
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.dog_habbies;
      TextView dogHabbies = ViewBindings.findChildViewById(rootView, id);
      if (dogHabbies == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, dogAge, dogHabbies,
          dogImage, dogName);
    }
