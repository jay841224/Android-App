...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {
        ...
        val dogHabTextView: TextView? = view?.findViewById(R.id.dog_habbies)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        // 綁定DogCardViewHolder裡面的view
        val resources = context?.resources
        var item: Dog = DataSource.dogs[position]
        holder.dogNameTextView!!.text = item.name
        holder.dogAgeTextView!!.text = String.format(resources?.getString(R.string.dog_age)!!, item.age)
        holder.dogHabTextView!!.text = String.format(resources?.getString(R.string.dog_hobbies)!!, item.hobbies)
